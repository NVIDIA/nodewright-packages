...
Bumps EKS defaults to kernel `6.17.0-1017-aws` and EFA `1.48.0`. `resolve_full_kernel` now appends the `-64k` page-size variant on arm64, so GB200 (Grace) installs `6.17.0-1017-aws-64k` while H100 (x86_64) stays on `6.17.0-1017-aws`.

| service | accelerator | kernel              | efa         | chrony | raid0 | OFI | bcm headers alias |
|---------|-------------|---------------------|-------------|--------|-------|-----|-------------------|
| eks     | h100        | 6.17.0-1017-aws     | 1.48.0      |  Y     |  Y    |  Y  |  N                |
| eks     | gb200       | 6.17.0-1017-aws-64k | 1.48.0      |  Y     |  Y    |  Y  |  N                |
| bcm     | h100        | n/a                 | n/a         |  N     |  N    |  N  |  Y                |
| bcm     | gb200       | n/a                 | n/a         |  N     |  N    |  N  |  Y                |