...
# OKE-specific vars (unset for eks flavors; harmless to export empty)
export CONFIGMAP_DIR DEFAULTS_DIR SERVICE ACCELERATOR COMBINATION KERNEL LUSTRE EFA \
  KERNEL_META DOCA_VERSION OCI_HPC_NET_DEVICE_NAMES_VERSION OCI_HPC_GPU_CONFIGURE_VERSION \
  OCI_HPC_ARTIFACTS_URL LUSTRE_DKMS_NAME LUSTRE_DKMS_VERSION LUSTRE_PKG_VERSION \
  LUSTRE_ARTIFACTS_URL NTP_SERVER
